...
export default function Welcome() {
    return (
        <Card sx={{maxWidth: {xs: "full", sm:"75%", lg:"50%"}}}>
            <CardContent sx={{display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center"}}>
                ...
                <Divider/>
                <div className='flex justify-center flex-wrap items-center gap-4 md:gap-20 mt-2'>
                    ...
                    <div className='flex flex-row gap-4'>
                        <div className='flex flex-col items-center justify-center'>
                            ...
                            <Link href={"https://github.com/jesseilc123/aquarium_parameters_tester"}>GitHub</Link>
                        </div>
                        <div className='flex flex-col items-center justify-center'>
                            <Avatar src='/devto.png'/>
                            <Link href={"https://dev.to/jesseilc123"}>Dev.to</Link>
                        </div>
                        <div className='flex flex-col items-center justify-center'>
                            <Avatar src="/linkedin.png"/>
                            <Link href={"https://www.linkedin.com/in/jesse-ilc-se2023/"}>LinkedIn</Link>
                        </div>
                    </div>
                </div>
            </CardContent>
